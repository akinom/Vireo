...
INSERT INTO email_template (id, displayorder, message, name, subject, systemrequired) VALUES (1, 0, '
...
The Vireo Team
', 'SYSTEM New User Registration', 'Vireo Account Registration', true);
INSERT INTO email_template (id, displayorder, message, name, subject, systemrequired) VALUES (2, 0, '
Dear {FULL_NAME}: 
...
The Vireo Team
', 'SYSTEM Needs Corrections', 'Received {DOCUMENT_TYPE} submission needs corrections', true);
INSERT INTO email_template (id, displayorder, message, name, subject, systemrequired) VALUES (3, 0, '
...
The Vireo Team
', 'SYSTEM Verify Email Address', 'Verify Email Address', true);
INSERT INTO email_template (id, displayorder, message, name, subject, systemrequired) VALUES (4, 0, '
A Thesis Central system administrator has sent this email address a test email. You may
disregard this test.

If you need assistance with your account, please email
thesis.central@princeton.edu
', 'SYSTEM Email Test', 'Thesis Central Email Test', true);
INSERT INTO email_template (id, displayorder, message, name, subject, systemrequired) VALUES (5, 0, '
...
The Vireo Team
', 'SYSTEM Advisor Review Request', 'Review: {FULL_NAME}''s {DOCUMENT_TYPE} submission', true);
INSERT INTO email_template (id, displayorder, message, name, subject, systemrequired) VALUES (6, 0, '
Dear {FULL_NAME}: 

You are receiving this message to confirm the successful submission of your {DOCUMENT_TYPE} to the Thesis Office. We will begin to review your submission as soon as we can.
...
You do not need to reply to this message. The status of your submission, along with any necessary comments or information, is available at the web address listed above. If you have any questions about your submittal, feel free to contact our office. 

The Vireo Team
', 'SYSTEM Initial Submission', 'Received {DOCUMENT_TYPE} submission', true);
INSERT INTO email_template (id, displayorder, message, name, subject, systemrequired) VALUES (7, 0, '

{DOCUMENT_TITLE}, authored by {FULL_NAME} has been deposited.
...
', 'SYSTEM Deposit Notification', 'Deposit Notification', true);
...
INSERT INTO email_workflow_rule_conditions (id, conditionid, conditiontype, displayorder) VALUES (1, NULL, 0, 1);
INSERT INTO email_workflow_rule_conditions (id, conditionid, conditiontype, displayorder) VALUES (2, NULL, 0, 2);
...
--
-- Name: seq_actionlog; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_actionlog', 1, false);


--
-- Name: seq_administrative_groups; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_administrative_groups', 1, false);


--
-- Name: seq_attachment; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_attachment', 1, false);


--
-- Name: seq_college; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_college', 1, false);


--
-- Name: seq_committee_member; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_committee_member', 1, false);


--
-- Name: seq_committee_member_role_type; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_committee_member_role_type', 3, true);


--
-- Name: seq_configuration; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_configuration', 1, false);


--
-- Name: seq_custom_action_definition; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_custom_action_definition', 1, false);


--
-- Name: seq_custom_action_value; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_custom_action_value', 1, false);


--
-- Name: seq_degree; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_degree', 1, false);


--
-- Name: seq_department; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--
...
--
-- Name: seq_deposit_location; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_deposit_location', 1, false);


--
-- Name: seq_document_type; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_document_type', 1, false);


--
-- Name: seq_email_template; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_email_template', 7, true);


--
-- Name: seq_email_workflow_rule_conditions; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_email_workflow_rule_conditions', 2, true);


--
-- Name: seq_email_workflow_rules; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_email_workflow_rules', 2, true);


--
-- Name: seq_embargo_type; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_embargo_type', 9, true);


--
-- Name: seq_graduation_month; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_graduation_month', 1, false);


--
-- Name: seq_language; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_language', 1, false);


--
-- Name: seq_major; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_major', 1, false);


--
-- Name: seq_person; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--
...
--
-- Name: seq_preference; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_preference', 1, false);


--
-- Name: seq_program; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_program', 1, false);


--
-- Name: seq_search_filter; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_search_filter', 1, false);


--
-- Name: seq_submission; Type: SEQUENCE SET; Schema: public; Owner: thesis-dev
--

SELECT pg_catalog.setval('seq_submission', 1, false);
